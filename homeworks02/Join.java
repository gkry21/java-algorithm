...
public class Join {
	...
	public static void main(String[] args) {
		...
		System.out.println("정보를 입력해주십시오.");
		...
		System.out.println("생년월일(예 : 1990-05-05) :");
		String bd = scan.next();
		...
		System.out.println("생년월일(예 : 1990-05-05) :" + bd);
		System.out.println("성인여부(성인true,미성년false) : " + grow );
		System.out.println("키(소수점 첫째자리까지) :" + height +"cm");
		System.out.println("몸무게(소수점 첫째자리까지) :" + weight + "kg");
